...
const PopoverPortal = ({ children }: { children: React.ReactNode }) => (
  <PopoverPrimitive.Portal>
    <Portal.Root>
      <div className="fixed inset-0 z-[100] bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
      {children}
    </Portal.Root>
  </PopoverPrimitive.Portal>
);
...
const PopoverWithOverlayContent = React.forwardRef<
  React.ElementRef<typeof PopoverPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content>
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <PopoverPortal>
...
export { Popover, PopoverContent, PopoverTrigger, PopoverWithOverlayContent };
